...
final class QueryTest extends TestCase
{
    ...
    public function testSetterAndGetters2(): string{
        ...
        self::assertEmpty($res,'not found');
        self::assertNotEmpty($res,'it did work');
        return  'cant connect it to the database sir what ever i do ';

    }
    public function testSetterAndGetters3(): string {
        $res = DependencyContainer::getSqlDriver()->insert('locationentity',['test'],['value']);
        self::assertEmpty($res,'not found');
        self::assertNotEmpty($res,'it did work');
        return  'cant connect it to the database sir what ever i do ';
